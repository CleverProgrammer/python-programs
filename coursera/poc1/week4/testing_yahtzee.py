...
def run_example():
    ...
    print("gen_all_holds( (4,6) ), --> ", gen_all_holds((4, 6)))
    print("\n-----Testing strategy()----------\n")
    print("strategy((1,), 6) -->", strategy((1,), 6))
    print("Expected --> expected (3.5, ())")
    #print(expected_value((2, 2), 6, 2))
    #print("expected_value: %s" % str(expected_value((3, 3), 8, 5)))
    #print("expected --> 11.3590087891")
    #>>>gen_all_holds( (4,6) )
    #set([ (4,6), (), (6,), (4,) ])
    # gen_all_holds((4, 6)) expected set([(4, 6), (), (6,), (4,)]) but received set([(6, 4), (4, 6), (6, 6), (4, 4), (4,), (), (6,)])
